...
//
//	mockgen -source=user_usecase.go -destination=../../usecase/mocks/mock_user_usecase.go -package=mocks
//
...
func (mr *MockUserUsecaseMockRecorder) GetUserById(id any) *gomock.Call {
...
func (mr *MockUserUsecaseMockRecorder) SetUser(username, gender, name, address any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
