...
//
//	mockgen -source=account_usecase.go -destination=../../usecase/mocks/mock_account_usecase.go -package=mocks
//
...
func (mr *MockAccountUsecaseMockRecorder) GetAccountInfoByAccount(account any) *gomock.Call {
...
func (mr *MockAccountUsecaseMockRecorder) InsertAccount(account any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
